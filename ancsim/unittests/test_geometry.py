...
@given(st.integers(min_value=3, max_value=100), st.floats(min_value=0.1, max_value=100), 
                st.floats(min_value=-1000, max_value=1000), st.floats(min_value=-1000, max_value=1000))
def center_single_circle(numPoints, rad, xCenter, yCenter):
    ...
    assert(np.abs(center[0,0]-xCenter)<1e-10 and np.abs(center[0,1]-yCenter)<1e-10)